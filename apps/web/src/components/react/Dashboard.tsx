              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {user.profile.currentWeight
                    ? `${parseFloat(user.profile.currentWeight).toFixed(1)} lbs`
                    : 'Not set'}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {user.profile.goalWeight
                    ? `${parseFloat(user.profile.goalWeight).toFixed(1)} lbs`
                    : 'Not set'}
                </p>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="card">
              ...
              <div className="space-y-2 text-sm">
                {user.bio && (
                  <div className="mb-3 text-center text-gray-700 italic">"{user.bio}"</div>
                )}
                {user.profile.height && (
              ...
              <button className="btn bg-primary-600 text-white w-full mt-4">Edit Profile</button>
            </div>
          </div>
          {/* Activity Feed */}
          <div className="lg:col-span-2">
            <div className="card">
              ...
              <div className="text-center py-8 text-gray-500">
                ...
                <button className="btn bg-primary-600 text-white mt-4">Log Weight Entry</button>
              </div>
            </div>
            {/* Quick Actions */}
